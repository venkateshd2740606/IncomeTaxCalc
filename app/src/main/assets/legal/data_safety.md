# IncomeTaxCalc — Google Play Data Safety Form Reference
...
- **Users can request deletion:** Contact privacy@IncomeTaxCalc.game; local data cleared via app settings or uninstall

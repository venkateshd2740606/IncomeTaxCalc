package com.incometaxcalc.domain.model
...
/** Sort palette index 0..N-1 mapped to UI colors in [IncomeTaxCalcPalette]. */
data class IncomeTaxCalcLevel(
    val id: Long = 0,
    val seed: Long,
    val levelNumber: Int,
    val difficulty: Difficulty,
    val initialTubes: List<List<Int>>,
    val tubeCapacity: Int = IncomeTaxCalcLevel.DEFAULT_CAPACITY,
    val colorCount: Int,

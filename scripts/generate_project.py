#!/usr/bin/env python3
"""Generate EMICalculator Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\EMICalculator")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "emicalculator"
TEST = APP / "src" / "test" / "java" / "com" / "emicalculator"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "emicalculator"
...
android {
    namespace = "com.emicalculator"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.emicalculator.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.emicalculator.data.** { *; }
-keep class com.emicalculator.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "emicalculator-game",
    "storage_bucket": "emicalculator-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.emicalculator.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating EMICalculator project files...")

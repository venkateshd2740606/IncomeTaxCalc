...
1. Open `D:\Work\Games\IncomeTaxCalc` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `IncomeTaxCalcEngine.kt` (tube pour logic) and update the game board UI component.
